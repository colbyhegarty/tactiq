                      ...
                      >
                        {drill.svg_url && (
                          <View style={ms.drillImg}>
                            <Image source={{ uri: drill.svg_url + '?v=21' }} style={{ width: '100%', height: '100%' }} contentFit="cover" />
                          </View>
                        )}
    ...
    <View style={ac.card}>
      ...
      {activity.drill_svg_url && (
        <View style={ac.diagramWrap}>
          <Image source={{ uri: activity.drill_svg_url + '?v=21' }} style={ac.diagram} contentFit="contain" />
        </View>
      )}
